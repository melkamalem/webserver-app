// Create a function to validate the name field
function validateName(name) {
  ...
  // Create a function to define rules for the validation of email
  ...
  // Create a function to define rules for the validation of textarea
